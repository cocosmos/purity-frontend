...
const darkPalette = ['hsla(0, 15%, 1%, 1)','hsla(0, 15%, 9%, 1)','hsla(0, 15%, 17%, 1)','hsla(0, 15%, 22%, 1)','hsla(0, 15%, 26%, 1)','hsla(0, 15%, 31%, 1)','hsla(0, 15%, 36%, 1)','hsla(0, 15%, 41%, 1)','hsla(0, 15%, 45%, 1)','hsla(0, 15%, 50%, 1)','hsla(0, 15%, 93%, 1)','hsla(0, 15%, 99%, 1)']
const lightPalette = ['hsla(0, 15%, 99%, 1)','hsla(0, 15%, 91%, 1)','hsla(0, 15%, 83%, 1)','hsla(0, 15%, 78%, 1)','hsla(0, 15%, 74%, 1)','hsla(0, 15%, 69%, 1)','hsla(0, 15%, 64%, 1)','hsla(0, 15%, 59%, 1)','hsla(0, 15%, 55%, 1)','hsla(0, 15%, 50%, 1)','hsla(0, 15%, 15%, 1)','hsla(0, 15%, 1%, 1)']
